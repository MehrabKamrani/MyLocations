...
//  MyLocations
//
//  Created by Mehrab on 14/12/2017.
...
class HudView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        let boxReact = CGRect(x: round(bounds.size.width - boxWidth) / 2,
                              y: round(bounds.size.height - boxHeight) / 2,
                              width: boxWidth,
                              height: boxHeight)
        
        let roundRect = UIBezierPath(roundedRect: boxReact, cornerRadius: 10)
